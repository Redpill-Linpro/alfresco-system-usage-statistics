<@markup id="css" >
  <#-- CSS Dependencies -->
  <@link rel="stylesheet" type="text/css" href="${url.context}/res/rl/components/console/site-statistics-console.css"  group="console" />
...
<@markup id="js">
	...
	<@script type="text/javascript" src="${url.context}/res/rl/components/console/site-statistics-console.js"  group="console" />
