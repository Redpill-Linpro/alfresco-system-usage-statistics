...
public class GenerateUserStatistics extends ClusteredExecuter {
  ...
  protected void storeResult(String json) {
    ...
    NodeRef userStatisticsNodeRef = nodeService.getChildByName(statisticsNodeRef, ContentModel.ASSOC_CONTAINS,
        FOLDER_NAME_USER_STATISTICS);
    if (userStatisticsNodeRef == null) {
      userStatisticsNodeRef = fileFolderService
          .create(statisticsNodeRef, FOLDER_NAME_USER_STATISTICS, ContentModel.TYPE_FOLDER).getNodeRef();
    }
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    Assert.notNull(activeUsers, "[Assertion failed] - this argument is required; it must not be null");
