<@markup id="css" >
  <#-- CSS Dependencies -->
  <@link rel="stylesheet" type="text/css" href="${url.context}/res/rl/components/console/summary-statistics-console.css"  group="console" />
...
<@markup id="js">
	...
	<@script type="text/javascript" src="${url.context}/res/rl/components/console/summary-statistics-console.js"  group="console" />
  ...
  <div id="${el}-body" class="statistics-console">
      <div id="${el}-main" class="hidden">
          <div>
              ...
              <div>
                  <div id="${el}-statistics-summary" class="statistics-summary hidden"></div>
              </div>
          </div>
      </div>
  </div>
